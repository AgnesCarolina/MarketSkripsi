...
try:
    sqliteConnection = sqlite3.connect('C:/Users/Agnes/Downloads/Compressed/TEST - Copy/market/market.db')
...
# ************* untuk update *******************
    ...
    for i in range(len(trialname)):
        ...
        cursor.execute("""update dbarang set totalStok = ? where namaBarang = ?""", (a[0], b[0]))
        sqliteConnection.commit()
        # masalah : tipe => hasil pengurangan 180-1 = 1,7,9 berubah jadi list
# # ************* untuk update *******************
